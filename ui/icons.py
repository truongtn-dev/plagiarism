"""Inline SVG icons (Lucide-style, MIT-compatible paths)."""

from __future__ import annotations

ICONS: dict[str, str] = {
    "logo": '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="m9 15 2 2 4-4"/>',
...
def svg_icon(name: str, size: int = 20, css_class: str = "ico") -> str:
...
def icon_label(name: str, text: str, size: int = 18) -> str:
    return f'<span class="icon-label">{svg_icon(name, size)}<span>{text}</span></span>'
